    ...
    <div className="max-w-3xl mx-auto text-center pt-20">
      ...
      <div className="mt-12">
        ...
        <div className="flex justify-center items-center space-x-4 mt-4">
             <a href="mailto:jaiswaldevashish5@gmail.com" className="text-brand-primary hover:underline">jaiswaldevashish5@gmail.com</a>
             <span className="text-text-secondary">|</span>
             <a href="https://www.linkedin.com/in/devashish-jaiswal-714075135/" target="_blank" rel="noopener noreferrer" className="text-brand-primary hover:underline">LinkedIn</a>
        </div>
      </div>
    </div>
  );
